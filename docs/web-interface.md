...
***Коротке [відео](./theme-video.md) зміни теми інтерфейсу.***
...
- [x] Для зміни обмеженнь та затримки потрібно клацнути на поточне значення параметра та ввести нове значення й підтвердити кнопкою *ОК*.

***Коротке [відео](./limits-video.md) налаштування обмеження.***

!!! warning "Зверніть увагу!"   
    Допустимий діапазон значення обмежень струму та напруги залежить від моделі перетворювача (номінальної потужності).   
    При введенні значення поза діапазоном з'явиться спливаюче червоне вікно з помилкою.   

    | **Модель** | **Допустимий діапазон<br>обмежень струму, A** | **Допустимий діапазон<br>обмежень напруги, V** | **Допустимий діапазон<br>затримки, секунд** | 
    |---|---|---|---| 
    | ІПКЗ-600-50 | Від 0 до 13.0 | Від 0 до 51.0 | Від 0 до 300 |
    | ІПКЗ-1200-50 | Від 0 до 25.0 | Від 0 до 51.0 | Від 0 до 300 |
    | ІПКЗ-2400-50 | Від 0 до 49.0 | Від 0 до 51.0 | Від 0 до 300 |
    | ІПКЗ-3000-50 | Від 0 до 61.0 | Від 0 до 51.0 | Від 0 до 300 |
...
- В пункті *Імпульсів за kW⋅h* вводиться кількість імпульсів, які виробляє лічильник електроенергії перетворювача за одну kW⋅h.   
  ...
  Заводське значення 6400 для встановленного лічильника.  
...
=== "Опис сторінки"
    ...
    |---                    |---    |
    | Модель  	            | ІПКЗ-1200-50 {.tab-example} |
    ...
    | Версія апаратного забезпечення  | 1.0 {.tab-example} |
    | Версія програмного забезпечення | 1.2 {.tab-example} |
...
<div class="annotate" markdown>
- [x] Прошивка має формат `ipkz_update_a_b.bin`, де `a` та `b` це версія. Наприклад, `ipkz_update_1_3.bin` це оновлення до версії `1.3`.
