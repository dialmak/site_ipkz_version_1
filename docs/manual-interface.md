...
!!! info "Автоматичний перехід при бездіяльності"
    Якщо оператор не здійснює жодних команд, то виконується автоматичний перехід до головної інформаційної сторінки через 20 секунд бездіяльності.
...
У випадку вибору ручного режиму відкриється сторінка налаштуваннь коефіциєнтів ПІД регулятора.  
...
### Меню системних налаштуваннь { #manual-settings-system data-toc-label='Меню системних налаштуваннь' }
...
!!! info "Автоматичний перехід при бездіяльності"
    Якщо оператор не здійснює жодних команд, то виконується автоматичний перехід до сторінки системних налаштуваннь через 20 секунд бездіяльності.

#### Вибір мови інтерфейсу { #manual-settings-system-date data-toc-label='Мова інтерфейсу' }
...
!!! info "Автоматичний перехід при бездіяльності"
    Якщо оператор не здійснює жодних команд, то виконується автоматичний перехід до меню налаштувань через 20 секунд бездіяльності.
