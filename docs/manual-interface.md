...
![Головна інформація.](./assets/images/nex/info1.png)

Друга інформаційна сторінка є додатковою й показується протягом 6 секунд. 

![Додаткова інформація.](./assets/images/nex/info2.png)
...
!!! note "Команди для цих сторінок."
    ...
    - Подвійне натискання ручки :material-clock-time-one-outline: :material-clock-time-one-outline: та ліва сенсорна зона перехід до [вибору режиму роботи]( #manual-interface-mode).
...
***Коротке [відео](./nex-mode-video.md) налаштування режиму роботи.***
